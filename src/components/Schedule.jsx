...
const Schedule = () => {
  ...
  },
  {
    ...
    cardDetailedText: "For the groom's 30th birthday, the bride organized a special trip to Jamaica, the birth place of his favorite musician, Bob Marley. It was their third birthday celebration as a couple and their first international trip together.",
    media: {
      type: "VIDEO",
      source: {
